...
namespace Triumph.J1939.Tests
{
    ...
    {
        J1939_21UsbCanII j1939tp = new J1939_21UsbCanII();
        J1939Client client = new J1939Client();
        [TestInitialize]
        public void Init()
        {
            j1939tp.SourceAddress = 0xA1;
            j1939tp.DestAddress = 0xF4;
            client.tp = j1939tp;
        }
        ...
        //        j1939tp.SendData(0x007100, 0xF4, data);
        //        //ecu.JobThread();
        //        Thread.Sleep(10);
        ...
        //            0x5C, 0x5D, 0x5E, 0x5F];
        //        j1939tp.SendData(0x007100, 0xF4, data2);
        //        //ecu.JobThread();
        //        Thread.Sleep(10);
        //        j1939tp.Notify(0x1CECA1F4, [0x11, 0x10, 0x01, 0xFF, 0xFF, 0x00, 0x71, 0x00], 0);
        //        Thread.Sleep(10);
        ...
        //{
        //    j1939tp.SendRequest(0, 0x007100, 0xF4);
        //    Thread.Sleep(100);
